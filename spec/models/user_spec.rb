...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      it 'nicknameとemail、passwordとpassword_confirmation、family_nameとfirst_name、family_name_kanaとfirst_name_kana、birthdayが正しく存在すれば登録できること' do
  ...
  describe 'ユーザーログイン' do
    context 'ログインできるとき' do
      it 'emailとpasswordの組み合わせが正しく存在すればログインできる' do
        expect(@user).to be_valid
      end
    end
